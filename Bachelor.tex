...
Dies bedeutet, dass die Feldlinien, welche senkrecht auf der Oberfläche stehen, bei kleinen Krümmungsradien dichter beieinander liegen, was einem st\"arkerem Feld entspricht.
...
Ist $\gamma\ll 1$ ($F$ groß $\Rightarrow$ optisches Feld gr\"o{\ss}er Potential stärker gebogen), so wird die Emission bestimmt durch das Tunneln der Elektronen.
