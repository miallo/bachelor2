...
Dies rechtfertigt das Aussortieren von Werten wie in Grafik \ref{fig:520e} was von Hand geschah.
...
Plottet man wie in Abb. \ref{fig:ges_messung} zu sehen die Steigung gegen die Wellenlänge, so ergibt sich nicht das einfachste zu erwartende Bild einer Treppenfunktion was aus Gleichung \ref{eq:nomega} folgt.
...
Weitere Effekte, welche zu einer ``Linearisierung'' der Stufenfunktion führen können sind in Kapitel \ref{sec:erklaerung_lin} aufgeführt.
